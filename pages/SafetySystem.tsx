            ...
            <div className="lg:w-1/2 w-full">
               <div className="bg-amber-50 rounded-[2rem] p-8 border border-amber-200 relative">
                  ...
                  <p className="text-sm text-amber-800 leading-relaxed font-medium">
                    "입찰파트너는 불법적인 컨설팅이나 자격 없는 자의 대리 업무를 철저히 배격합니다. 모든 입찰 대행은 법원 등록 공인중개사가 직접 수행하며, 의뢰인에게 제공되는 모든 리포트는 투명한 근거 자료를 바탕으로 작성됨을 약속드립니다."
                  </p>
                  <div className="mt-8 pt-6 border-t border-amber-200 text-right">
                     <span className="font-serif text-xl font-bold text-amber-900">대표이사 전문가 그룹 (인)</span>
                  </div>
               </div>
            </div>
         </div>
        ...
        <div className="bg-[#002147] rounded-[3rem] p-12 text-white flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="md:w-2/3">
            ...
            <p className="opacity-70 mb-8 leading-relaxed">
              분석 오류로 인해 발생한 재산상 손해에 대해 입찰파트너는 법령이 정한 범위 내에서 책임을 집니다. 
